...
public class AutoPedroRedFar3rdRow extends AutoPedroCommon {
    ...
    public void setPath(){
        ...
        poseList.add(new PoseItem(red_near_score,"shoot","intake_3rd_row"));
        poseList.add(new PoseItem(red_3rd_row_start,"intake","intake_3rd_row"));
        poseList.add(new PoseItem(red_3rd_row_end,"none","intake_3rd_row"));
        poseList.add(new PoseItem(red_near_score,"shoot","turn_left_1"));
        ...
        poseList.add(new PoseItem(red_near_turn_left,"intake","intake_1"));
        poseList.add(new PoseItem(red_near_corner,"none","shoot_1"));
        poseList.add(new PoseItem(red_near_score,"shoot","intake_2"));

        /*
        pathList.add(new PoseItem(red_far_score,red_2nd_row_start,"none","go_to_2nd_row"));
        pathList.add(new PoseItem(red_2nd_row_start,red_2nd_row_end,"intake","intake_2nd_row"));
        pathList.add(new PoseItem(red_2nd_row_end,red_gate,"none","shoot_2nd_row"));
        pathList.add(new PoseItem(red_gate,red_far_score,"shoot","shoot_2nd_row"));

        pathList.add(new PoseItem(red_far_score,red_1st_row_start,"none","go_to_1st_row"));
        pathList.add(new PoseItem(red_1st_row_start,red_1st_row_end,"intake","intake_1st_row"));
        pathList.add(new PoseItem(red_1st_row_end,red_far_score,"shoot","shoot_1st_row"));

        pathList.add(new PoseItem(red_far_score,red_3rd_row_start,"none","go_to_3rd_row"));
        pathList.add(new PoseItem(red_3rd_row_start,red_3rd_row_end,"intake","intake_3rd_row"));
        pathList.add(new PoseItem(red_3rd_row_end,red_far_score,"shoot","shoot_3rd_row"));
        pathList.add(new PoseItem(red_far_score,red_parking,"none","parking"));
